...
`;
        ...
        function remove_mardi(div_id) {
            ...
            let html = "<div class='column' id='new_btn_mardi'><button onClick=add_mardi()>new Mardi</button></div>";
            h2.insertAdjacentHTML("afterbegin", html);
...
`;
        ...
        function remove_mercredi(div_id) {
            ...
            let html = "<div class='column' id='new_btn_mercredi'><button onClick=add_mercredi()>new Mercredi</button></div>";
            h2.insertAdjacentHTML("afterbegin", html);
...
`;
        ...
        function remove_jeudi(div_id) {
            ...
            let html = "<div class='column' id='new_btn_jeudi'><button onClick=add_jeudi()>new Jeudi</button></div>";
            h2.insertAdjacentHTML("afterbegin", html);
...
`;
        ...
        function remove_vendredi(div_id) {
            ...
            let html = "<div class='column' id='new_btn_vendredi'><button onClick=add_vendredi()>new Vendredi</button></div>";
            h2.insertAdjacentHTML("afterbegin", html);
