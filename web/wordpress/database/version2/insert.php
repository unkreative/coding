...
{    
     ...
     $sql = "INSERT INTO vendredi (ID, date, potage, subtitle_potage, plat_1, subtitle_plat_1, plat_2, subtitle_plat_2, accompagnement, subtitle_accompagnement, légumes, subtitle_légumes, dessert, subtitle_dessert)
     VALUES ('$ID', '$date_vendredi', '$potage_vendredi', '$subtitle_potage_vendredi', '$plat_1_vendredi', '$subtitle_plat_1_vendredi', '$plat_2_vendredi', '$subtitle_plat_2_vendredi', '$accompagnement_vendredi', '$subtitle_accompagnement_vendredi', '$légumes_vendredi', '$subtitle_légumes_vendredi', '$dessert_vendredi', '$subtitle_dessert')";
     mysqli_query($conn, $sql);
 
     mysqli_close($conn);

}
header("Location: http://localhost:8888/wordpress/database/version2/page.php");
