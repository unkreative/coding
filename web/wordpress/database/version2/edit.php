...
if ($result_vendredi->num_rows > 0) {
  ...
  while($row = $result_vendredi->fetch_assoc()) {
    ...
    array_push($arr_date_vendredi, $row["date"]);
...
<div id="vendredi">
    <h1 id="del_vendredi" class="box">vendredi</h1>
</div>
...
try {
        ...
        let div_vendredi = document.getElementById("del_vendredi");
...
`;
        ...
        const parentelement_vendredi = document.getElementById("vendredi");
        let html_vendredi = `
            <div id="del_vendredi" class="box">
                    <h1>vendredi</h1>
                        
                            <label for="date_vendredi">date</label>
                            <input type="date" name="date_vendredi" id="date_vendredi" value="${date_vendredi}">
                            <br>
                            <br>

                            <label for="potage_vendredi">potage</label>
                            <input type="text" id="potage_vendredi" name="potage_vendredi" placeholder="plat" value="${potage_vendredi}">
                            <input type="text" id="subtitle_potage_vendredi" name="subtitle_potage_vendredi" placeholder="subtitle" value="${subtitle_potage_vendredi}">
                        <br>
                        <br>
                            <label for="plat_1_vendredi">plat 1</label>
                            <input type="text" id="plat_1_vendredi" name="plat_1_vendredi" placeholder="plat" value="${plat_1_vendredi}">
                            <input type="text" id="subtitle_plat_1_vendredi" name="subtitle_plat_1_vendredi" placeholder="subtitle" value="${subtitle_plat_1_vendredi}">
                        <br>
                        <br>
                            <label for="plat_2_vendredi">plat 2</label>
                            <input type="text" id="plat_2_vendredi" name="plat_2_vendredi" placeholder="plat" value="${plat_2_vendredi}">
                            <input type="text" id="subtitle_plat_2_vendredi" name="subtitle_plat_2_vendredi" placeholder="subtitle" value="${subtitle_plat_2_vendredi}">
                        <br>
                        <br>
                            <label for="accompagnement_vendredi">accompagnement</label>
                            <input type="text" id="accompagnement_vendredi" name="accompagnement_vendredi" placeholder="plat" value="${accompagnement_vendredi}">
                            <input type="text" id="subtitle_accompagnement_vendredi" name="subtitle_accompagnement_vendredi" placeholder="subtitle" value="${subtitle_accompagnement_vendredi}">
                            <br>
                            <br>
                                <label for="légumes_vendredi">légumes</label>
                                <input type="text" id="légumes_vendredi" name="légumes_vendredi" placeholder="plat" value="${légumes_vendredi}">
                                <input type="text" id="subtitle_légumes_vendredi" name="subtitle_légumes_vendredi" placeholder="subtitle" value="${subtitle_légumes_vendredi}">
                            <br>
                            <br>
                                <label for="dessert_vendredi">dessert</label>
                                <input type="text" id="dessert_vendredi" name="dessert_vendredi" placeholder="plat" value="${dessert_vendredi}">
                                <input type="text" id="subtitle_dessert_vendredi" name="subtitle_dessert_vendredi" placeholder="subtitle" value="${subtitle_dessert_vendredi}">
                            <br>
                            <br>
                            <br>
                        <br>
...
`;
        parentelement_vendredi.insertAdjacentHTML("afterbegin", html_vendredi);
