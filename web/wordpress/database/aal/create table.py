...
cursor.execute("CREATE TABLE `menu`.`vendredi` (`ID` INT(6), `date` DATE NULL DEFAULT NULL, `potage` TEXT , `subtitle_potage` TEXT , `plat_1` TEXT , `subtitle_plat_1` TEXT , `plat_2` TEXT , `subtitle_plat_2` TEXT , `accompagnement` TEXT , `subtitle_accompagnement` TEXT , `légumes` TEXT , `subtitle_légumes` TEXT , `dessert` TEXT , `subtitle_dessert` TEXT)")
