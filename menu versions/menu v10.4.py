...
class Plats:
    ...
    def get_plats_index(self):
        ...
        check = ['potage_', 'subtitle_potage', 'plat_1', 'subtitle_plat1', 'plat_2', 'subtitle_plat2', 'accompagnement',
                 'subtitle_accompagnement', 'légumes_', 'subtitle_légumes', 'dessert_', 'subtitle_dessert']
        ...
        plats_lst = [self.plat1, self.subtitle1, self.plat2, self.subtitle2, self.plat3, self.subtitle3, self.plat4,
                     self.subtitle4, self.plat5, self.subtitle5, self.plat6, self.subtitle6]
...
def main():
    ...
    internat.replace_in_xml = [['potage_', "potage"], ['plat_1', "plat 1"], ['plat_2', "plat 2"],
                               ['légumes_', "légumes"], ['dessert_', "dessert"]]
    ...
    def run_menu():
        ...
        root.filename = filedialog.askopenfilename(
            initialdir="Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/",
            title="select a file",
            filetypes=filetypes)
