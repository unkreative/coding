...
internat_indesign_template = '/Users/NLNEW/coding/menu du jour.indt'
...
def run_internat(input):
    ...
    internats_writexml(filename, xml, final_month)
    return filename

def internat_automate(id_file, filename, folder):
    server_connect()
    time.sleep(5)
    ...
    final_dir_pdf = f'Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/{folder}/{filename} internat'
    final_dir_id = f'Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/{folder}/{filename} internat indesign'
    ...
    import_xml(filename)
    id_replace(filename)
    id_export_file(filename, final_dir_pdf)
    save_id(filename, final_dir_id)
...
# export file as pdf
def id_export_file(filename, final_dir):
    pg.hotkey("command", "e")
    time.sleep(delay3)
...
def save_id(filename, final_dir):
    time.sleep(delay2)
    # for test purposes
...
def automate(id_file, filename):
    ...
    screen_path = "/Users/NLNEW/Desktop/screen.png"
    final_dir_pdf = f'Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/{filename}/{filename} menu'
    final_dir_id = f'Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/{filename}/{filename} menu indesign'
...
def overlay():
    ...
    def run_inter():
        ...
        internat_automate(internat_indesign_template, internat_filename, folder[0])
