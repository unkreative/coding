...
# TODO: internat date
# TODO: move mouse to center when automation, fixes some things i think
...
plats = {
    ...
    "platupper_org":['Potage_', 'Plat_1', 'Plat_2', 'Accompagnement', 'légumes__', 'Dessert_'],
...
def main():
    ...
    def run_menu():
        ...
        menu.input = menu_file(originfile_name)
        print(menu.input)
        menu.check_input()
    ...
    def run_internat():
        ...
        internat.input = internat_file(originfile_name)
...
potage_	 
subtitle_potage	 
plat_1	Salade aux lardons croûtons et vinaigre de framboise
subtitle_plat1	 
plat_2	Salade au manouri croûtons et vinaigre de framboise
subtitle_plat2	 
accompagnement	 
...
potage_	 
subtitle_potage	 
plat_1	Pâtes au pesto
subtitle_plat1	 
plat_2	Pâtes au pesto rouge
subtitle_plat2	 
accompagnement	 
subtitle_accompagnement	 
légumes_	 
...
potage_
subtitle_potage	 
plat_1	saucisse blanche à la moutarde

subtitle_plat1	 
plat_2	saucisse végétarienne à la moutarde

subtitle_plat2	 
accompagnement	riz
subtitle_accompagnement	 
légumes_	haricots verts
subtitle_légumes	 
dessert_
subtitle_dessert	 
...
potage_	 
subtitle_potage	 
plat_1	Bagel aux légumes grillés
subtitle_plat1	 
plat_2	salade
subtitle_plat2	 
accompagnement	 
