...
Subtitle_potage
plat1	Spaghetti sauce bolognaise
Subtitle_plat1
plat2	Spaghetti sauce bolognaise végétarienne 
subtitle_plat2
dessert 	Quatre quarts
Subtitle_dessert	gâteau breton à 4 ingrédients à quantités égales : farine, œufs, sucre, beurre

Mardi    04 janvier 	
potage 	Potage du jour
Subtitle_potage 
plat1	Pot-au-feu de porc 
Subtitle_plat1	Porc de la ferme Weis, Roodt 
plat2	Pot-au-feu de seitan maison 
Subtitle_plat2	pommes de terre nature, carottes, choux de Bruxelles, poireaux
dessert	Fruit
Subtitle_dessert
...
potage 	Potage du jour 
Subtitle_potage
plat1	Buns façon croque-monsieur : fromage et tofu au curry
Subtitle_plat1	Fromage Berdorfer 
plat2	Buns façon croque-monsieur : galettes de millet, poireaux et fromage Berdorfer
Subtitle_plat2
Légumes 	Salade 
Subtitle_légumes
dessert	Bavarois aux mandarines 
Subtitle_dessert

Jeudi  06 janvier 	
potage 	Potage du jour 
Subtitle_potage
plat1	Filets et cuisses de poulet jus lié 
Subtitle_plat1
plat2	Galette d’haricots blancs 
Subtitle_plat2
accompagnement 	Pommes de terre rôties
Subtitle_accompagnement
...
potage 	Potage du jour 
Subtitle_potage
plat1	Bouchée de poisson 
Subtitle_plat1	bouchée = vol-au-vent = croustade cyclindrique de pâte feuilletée
plat2	Bouchée aux légumes
Subtitle_plat2
accompagnement 	Riz de Camargue, champignons braisés
Subtitle_accompagnement	champignons de Diderrich de Glabach (Champs vu Glabech)
...
menu1 = check_input(menu1)
menu1 = check_input2(menu1)
menu1 = check_input3(menu1)

def wordsToList(strn):
    L = strn.split()
    cleanL = []
    abc1 = "abcdefghijklmnopqrstuvwxyz"
    abc = "=:;âôûéáœâà’.,ç'ïäöüè('^)1234567890!-_" + abc1
    ABC = abc1.upper()
    letters = abc + ABC
    for e in L:
        word = ''
...
def find_plats(indicator, list_plats, index_plats):
    index_plats.clear()
    plat_down_tmpl = ["potage", "subtitle_potage", "plat1", "subtitle_plat1", "plat2", "subtitle_plat2", "accompagnement", "subtitle_accompagnement", "Légumes", "subtitle_légumes", "dessert", "subtitle_dessert"]
    plat_up_tmpl = ["potage", "Subtitle_potage", "Plat1", "Subtitle_plat1", "Plat2", "Subtitle_plat2", "Accompagnement", "Subtitle_accompagnement", "Légumes", "Subtitle_légumes", "Dessert", "Subtitle_dessert"]
    plats_final = ["potage", "Subtitle_potage", "plat 1", "Subtitle_plat1", "plat 2", "Subtitle_plat2", "accompagnement", "Subtitle_accompagnement", "légumes", "Subtitle_légumes", "dessert",  "Subtitle_dessert"]
...
run_lundi = splitslots(lundi, lundi_plats_index, lundi_slot1a, lundi_slot1b, lundi_slot2a, lundi_slot2b, lundi_slot3a, lundi_slot3b, lundi_slot4a, lundi_slot4b, lundi_slot5a, lundi_slot5b, lundi_slot6a, lundi_slot6b)
print(lundi_slot1a, lundi_slot1b, lundi_slot2a, lundi_slot2b, lundi_slot3a, lundi_slot3b, lundi_slot4a, lundi_slot4b, lundi_slot5a, lundi_slot5b, lundi_slot6a, lundi_slot6b)
run_mardi = splitslots(mardi, mardi_plats_index, mardi_slot1a, mardi_slot1b, mardi_slot2a, mardi_slot2b, mardi_slot3a, mardi_slot3b, mardi_slot4a, mardi_slot4b, mardi_slot5a, mardi_slot5b, mardi_slot6a, mardi_slot6b)
run_mercredi = splitslots(mercredi, mercredi_plats_index, mercredi_slot1a, mercredi_slot1b, mercredi_slot2a, mercredi_slot2b, mercredi_slot3a, mercredi_slot3b, mercredi_slot4a, mercredi_slot4b, mercredi_slot5a, mercredi_slot5b, mercredi_slot6a, mercredi_slot6b)
run_jeudi = splitslots(jeudi, jeudi_plats_index, jeudi_slot1a, jeudi_slot1b, jeudi_slot2a, jeudi_slot2b, jeudi_slot3a, jeudi_slot3b, jeudi_slot4a, jeudi_slot4b, jeudi_slot5a, jeudi_slot5b, jeudi_slot6a, jeudi_slot6b)
run_vendredi = splitslots(vendredi, vendredi_plats_index, vendredi_slot1a, vendredi_slot1b, vendredi_slot2a, vendredi_slot2b, vendredi_slot3a, vendredi_slot3b, vendredi_slot4a, vendredi_slot4b, vendredi_slot5a, vendredi_slot5b, vendredi_slot6a, vendredi_slot6b)

def toxml(xml, day_plats, day_slot1a, day_slot1b, day_slot2a, day_slot2b, day_slot3a, day_slot3b, day_slot4a, day_slot4b, day_slot5a, day_slot5b, day_slot6a, day_slot6b):
    print()
    print(day_plats)
    print()
    print(day_slot1b)
...
run_lundi = toxml(lundi_xml, lundi_plats, lundi_slot1a, lundi_slot1b, lundi_slot2a, lundi_slot2b, lundi_slot3a, lundi_slot3b, lundi_slot4a, lundi_slot4b, lundi_slot5a, lundi_slot5b, lundi_slot6a, lundi_slot6b)
run_mardi = toxml(mardi_xml, mardi_plats, mardi_slot1a, mardi_slot1b, mardi_slot2a, mardi_slot2b, mardi_slot3a, mardi_slot3b, mardi_slot4a, mardi_slot4b, mardi_slot5a, mardi_slot5b, mardi_slot6a, mardi_slot6b)
run_mercredi = toxml(mercredi_xml, mercredi_plats, mercredi_slot1a, mercredi_slot1b, mercredi_slot2a, mercredi_slot2b, mercredi_slot3a, mercredi_slot3b, mercredi_slot4a, mercredi_slot4b, mercredi_slot5a, mercredi_slot5b, mercredi_slot6a, mercredi_slot6b)
run_jeudi = toxml(jeudi_xml, jeudi_plats, jeudi_slot1a, jeudi_slot1b, jeudi_slot2a, jeudi_slot2b, jeudi_slot3a, jeudi_slot3b, jeudi_slot4a, jeudi_slot4b, jeudi_slot5a, jeudi_slot5b, jeudi_slot6a, jeudi_slot6b)
run_vendredi = toxml(vendredi_xml, vendredi_plats, vendredi_slot1a, vendredi_slot1b, vendredi_slot2a, vendredi_slot2b, vendredi_slot3a, vendredi_slot3b, vendredi_slot4a, vendredi_slot4b, vendredi_slot5a, vendredi_slot5b, vendredi_slot6a, vendredi_slot6b)
...
def overlay():
    ...
    root.tk.call("source", "/Users/NLNEW/Downloads/Sun-Valley-ttk-theme-master/sun-valley.tcl")
    ...
    def open_file():
        ...
        # men = menu(f)
        # print(men)
        # ttk.Label(big_frame, text="menu number: " + men).pack(pady=10, padx=10)
        # write_to_clipboard(men)
    ...
    file_select = ttk.Label(big_frame, text="select your file").pack(pady=10)
    filebutton = ttk.Button(big_frame, text="open file", command=open_file).pack()


    button = ttk.Button(root, text="Change theme!", command=change_theme).pack(pady=10)
    root.mainloop()
