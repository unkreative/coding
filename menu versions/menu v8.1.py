...
def automate(indesign_file, filename):
    ...
    final_dir_pdf = f'Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/Menus/{filename}/{filename} menu.pdf'
    final_dir_id = f'Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/Menus/{filename}/{filename} menu indesign'
...
def internat_automate(id_file, filename, xml_filename):
    ...
    screen_path = "/Users/NLNEW/Desktop/screen.png"
    final_dir_pdf = f'Volumes/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/Menus/{filename}/{filename} internat.pdf'
...
def overlay():
    ...
    def run_men():
        ...
        root.filename = filedialog.askopenfilename(initialdir="smb://10.2.0.9/Classes_21_22/Chelsea Studios/1 Graphic Designers/2 Clients/16 Restaurant Mélusine/Menus", title="select a file",
                                                   filetypes=filetypes)
