...
def open_file():
    ...
    fileroot = ttk.Label(big_frame,text="origin file: " + root.filename).pack(pady=10)

    file_name = root.filename
    file_select = ttk.Label(big_frame, text="processing...").pack()
    time.sleep(1)
    ...
    men = menu(f)
    print(men)
    mennanme = ttk.Label(big_frame, text="menu number: " + men).pack(pady=10, padx=10)
...
def file(file_name):
    if ".txt" in file_name:
        ...
        error = ttk.Label(big_frame, text="file not compatible").pack(pady=10, padx=10, side="left")
